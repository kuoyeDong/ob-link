 ...
 */
public class RedOut extends ObNode {
    public static final int ISOPEN = 0;

    public RedOut(byte num, byte[] rfAddr, byte addr, byte[] id, byte[] serNum, byte parentType, byte type, byte[] version, byte surplusSence, byte gourpAddr, byte[] state) {
