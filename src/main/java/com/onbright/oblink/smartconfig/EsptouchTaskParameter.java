...
public class EsptouchTaskParameter implements IEsptouchTaskParameter {
    ...
    public EsptouchTaskParameter(Context context) {
...
//        WifiManager wmg = (WifiManager) context.getSystemService(Context.WIFI_SERVICE);
//        DhcpInfo dhcpinfo = wmg.getDhcpInfo();
//        int ip = dhcpinfo.serverAddress;
//        int mask = dhcpinfo.netmask;
//        int broadIp = (ip & mask) | ~mask;
//        if (broadIp != 0) {
//            broadCastIp = ((broadIp & 0xff) + "." + (broadIp >> 8 & 0xff) + "." + (broadIp >> 16 & 0xff) + "."
//                    + (broadIp >> 24 & 0xff));
//        }
//        return broadCastIp;
    }
